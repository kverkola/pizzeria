...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li
						<c:if test="${pageContext.request.requestURI == '${pageContext.servletContext.contextPath}/'}">
                        class="active"
                    </c:if>>
						<a href="<c:url value='/'/>">Home</a>
					</li>
					<li
						<c:if test="${pageContext.request.requestURI == '${pageContext.servletContext.contextPath}/menu'}">
                    class="active"
                </c:if>>
						<a href="<c:url value='/menu'/>">Menu</a>
					</li>
					<li
						<c:if test="${pageContext.request.requestURI == '${pageContext.servletContext.contextPath}/order'}">
                        class="active"
                    </c:if>>
						<a href="${pageContext.servletContext.contextPath}/order">Order</a>
					</li>
					<li
						<c:if test="${pageContext.request.requestURI == '${pageContext.servletContext.contextPath}/about'}">
                        class="active"
                    </c:if>>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3"
				style="float: right; position: fixed; right: 20px; top: 150px;">
				<div class="bs-example">
									...
									<tr>
										<td>${entry.key.name}
											<div style="width: 270px;">
												${entry.value}x
												<div style="float: right;">${entry.key.price *
													entry.value}$</div>
											</div>
										</td>
									</tr>
